...
>
	...
	<xsl:key name="field" match="model/freights/row/grower_in_load/row/@*[namespace-uri()=''][not(name()='id_freight')][not(name()='freight_type')][not(name()='freight_date')][not(name()='freight_code')][not(name()='special_credit_terms')][not(name()='currency')][not(name()='base_freight')][not(name()='pickup')][not(name()='unload')][not(name()='total_quote')][not(name()='iva')]" use="1"/>
	...
	<xsl:key name="dim" match="/*/growers" use="'grower'"/>
